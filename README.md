...
### [![Sentinel](https://img.shields.io/badge/SENTINEL-Big_Data_Anomaly_Detection_Platform-0D1117?style=for-the-badge&logo=apachespark&logoColor=E25A1C&labelColor=58A6FF)](https://github.com/Xyness/Sentinel)

Real-time Big Data platform analyzing cryptocurrency market streams to automatically detect suspicious behavior using unsupervised machine learning.

> **Pipeline:** Data Generator → **Kafka** → **Spark Structured Streaming** (Java) → **Parquet** → **Isolation Forest** ML → **FastAPI** → **Streamlit** dashboard
>
> Dual mode: simulated data with injected anomalies + live Binance WebSocket feed.

![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white) ![Java](https://img.shields.io/badge/Java-ED8B00?style=flat-square&logo=openjdk&logoColor=white) ![Apache Spark](https://img.shields.io/badge/Spark-E25A1C?style=flat-square&logo=apachespark&logoColor=white) ![Kafka](https://img.shields.io/badge/Kafka-231F20?style=flat-square&logo=apachekafka&logoColor=white) ![FastAPI](https://img.shields.io/badge/FastAPI-009688?style=flat-square&logo=fastapi&logoColor=white) ![Scikit-learn](https://img.shields.io/badge/Scikit--learn-F7931E?style=flat-square&logo=scikitlearn&logoColor=white) ![Streamlit](https://img.shields.io/badge/Streamlit-FF4B4B?style=flat-square&logo=streamlit&logoColor=white) ![Docker](https://img.shields.io/badge/Docker-2496ED?style=flat-square&logo=docker&logoColor=white)
...
> **Architecture:** 5-node LangGraph pipeline — **Planner** → **Search** → **Reader** → **Analyst** → **Writer**
>
> Autonomous scheduling via APScheduler. Full mock mode for zero-config demos.

![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white) ![FastAPI](https://img.shields.io/badge/FastAPI-009688?style=flat-square&logo=fastapi&logoColor=white) ![LangGraph](https://img.shields.io/badge/LangGraph-1C3C3C?style=flat-square&logo=langchain&logoColor=white) ![OpenAI](https://img.shields.io/badge/OpenAI-412991?style=flat-square&logo=openai&logoColor=white) ![Next.js](https://img.shields.io/badge/Next.js-000000?style=flat-square&logo=nextdotjs&logoColor=white) ![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white) ![PostgreSQL](https://img.shields.io/badge/PostgreSQL-4169E1?style=flat-square&logo=postgresql&logoColor=white) ![Docker](https://img.shields.io/badge/Docker-2496ED?style=flat-square&logo=docker&logoColor=white)

---

### [![Phantom](https://img.shields.io/badge/PHANTOM-Security_Reconnaissance_Framework-0D1117?style=for-the-badge&logo=rust&logoColor=white&labelColor=58A6FF)](https://github.com/Xyness/Phantom)

Full-stack attack surface analysis framework combining a Rust async port scanner, Python recon modules, and an interactive Next.js risk dashboard.

> **Capabilities:** Async TCP scanning + banner grabbing, DNS recon & zone transfer detection, TLS analysis, HTTP security scoring, OSINT (WHOIS, ASN, certificate transparency), CVE matching, weighted risk scoring (0–100), PDF report generation.
>
> Authorization-gated by design.

![Rust](https://img.shields.io/badge/Rust-000000?style=flat-square&logo=rust&logoColor=white) ![Tokio](https://img.shields.io/badge/Tokio-000000?style=flat-square&logo=rust&logoColor=white) ![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white) ![FastAPI](https://img.shields.io/badge/FastAPI-009688?style=flat-square&logo=fastapi&logoColor=white) ![Next.js](https://img.shields.io/badge/Next.js-000000?style=flat-square&logo=nextdotjs&logoColor=white) ![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white) ![PostgreSQL](https://img.shields.io/badge/PostgreSQL-4169E1?style=flat-square&logo=postgresql&logoColor=white) ![Docker](https://img.shields.io/badge/Docker-2496ED?style=flat-square&logo=docker&logoColor=white)
...
> **How it works:** Browser captures frames → FastAPI processes via InsightFace (**SCRFD** detection + **ArcFace** 512-dim embeddings) → cosine similarity matching → HUD overlay rendered on canvas.
>
> Multi-photo support per person, configurable threshold.

![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white) ![FastAPI](https://img.shields.io/badge/FastAPI-009688?style=flat-square&logo=fastapi&logoColor=white) ![InsightFace](https://img.shields.io/badge/InsightFace-5C3EE8?style=flat-square&logo=opencv&logoColor=white) ![ONNX](https://img.shields.io/badge/ONNX_Runtime-007CFF?style=flat-square&logo=onnx&logoColor=white) ![OpenCV](https://img.shields.io/badge/OpenCV-5C3EE8?style=flat-square&logo=opencv&logoColor=white) ![SQLite](https://img.shields.io/badge/SQLite-003B57?style=flat-square&logo=sqlite&logoColor=white) ![JavaScript](https://img.shields.io/badge/JavaScript-F7DF1E?style=flat-square&logo=javascript&logoColor=black)

---

### [![GitPulse](https://img.shields.io/badge/GITPULSE-GitHub_Activity_Visualizer-0D1117?style=for-the-badge&logo=github&logoColor=white&labelColor=58A6FF)](https://github.com/Xyness/GitPulse)

[![Live Demo](https://img.shields.io/badge/▶_Live_Demo-git--pulse--virid.vercel.app-58A6FF?style=flat-square&logo=vercel&logoColor=white)](https://git-pulse-virid.vercel.app)

Interactive GitHub profile visualization tool featuring constellation graphs (repos as a star map), animated contribution heatmaps, language timeline streamgraphs, GitHub Wrapped, compare mode, and embeddable widgets. Dynamic OG image generation.

![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white) ![Next.js](https://img.shields.io/badge/Next.js-000000?style=flat-square&logo=nextdotjs&logoColor=white) ![Tailwind CSS](https://img.shields.io/badge/Tailwind-06B6D4?style=flat-square&logo=tailwindcss&logoColor=white) ![D3.js](https://img.shields.io/badge/D3.js-F9A03C?style=flat-square&logo=d3dotjs&logoColor=white) ![Framer Motion](https://img.shields.io/badge/Framer_Motion-0055FF?style=flat-square&logo=framer&logoColor=white) ![shadcn/ui](https://img.shields.io/badge/shadcn/ui-000000?style=flat-square&logo=shadcnui&logoColor=white) ![Vercel](https://img.shields.io/badge/Vercel-000000?style=flat-square&logo=vercel&logoColor=white)

---

### [![PaperChat](https://img.shields.io/badge/PAPERCHAT-RAG_PDF_Chatbot-0D1117?style=for-the-badge&logo=files&logoColor=white&labelColor=58A6FF)](https://github.com/Xyness/PaperChat)

RAG-powered chatbot that answers questions from uploaded PDFs using semantic search and LLMs. Supports both cloud and local inference.

> **Features:** ChromaDB vector store, automatic chunking with deduplication, source references with page numbers, conversation history.
>
> Dual LLM support — **OpenAI** (GPT-4o-mini) or **Ollama** (Llama 3) for fully local usage.

![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white) ![FastAPI](https://img.shields.io/badge/FastAPI-009688?style=flat-square&logo=fastapi&logoColor=white) ![LangChain](https://img.shields.io/badge/LangChain-1C3C3C?style=flat-square&logo=langchain&logoColor=white) ![ChromaDB](https://img.shields.io/badge/ChromaDB-FF6446?style=flat-square&logoColor=white) ![OpenAI](https://img.shields.io/badge/OpenAI-412991?style=flat-square&logo=openai&logoColor=white) ![Ollama](https://img.shields.io/badge/Ollama-000000?style=flat-square&logo=ollama&logoColor=white) ![Streamlit](https://img.shields.io/badge/Streamlit-FF4B4B?style=flat-square&logo=streamlit&logoColor=white) ![Docker](https://img.shields.io/badge/Docker-2496ED?style=flat-square&logo=docker&logoColor=white)

---

### [![SimpleClaimSystem](https://img.shields.io/badge/SIMPLECLAIMSYSTEM-Open--Source_Minecraft_Plugin-0D1117?style=for-the-badge&logo=modrinth&logoColor=1BD96A&labelColor=58A6FF)](https://github.com/Xyness/SimpleClaimSystem)

![Stars](https://img.shields.io/github/stars/Xyness/SimpleClaimSystem?style=flat-square&color=58A6FF&label=Stars) ![Forks](https://img.shields.io/github/forks/Xyness/SimpleClaimSystem?style=flat-square&color=8B949E&label=Forks)

Chunk-based territory protection plugin for Minecraft servers. Active community, listed on SpigotMC, complete Gitbook wiki, and Discord support server. Compatible with Paper, Folia, Purpur, and Spigot (1.18+).

![Java](https://img.shields.io/badge/Java-ED8B00?style=flat-square&logo=openjdk&logoColor=white) ![PaperMC](https://img.shields.io/badge/PaperMC-000000?style=flat-square&logoColor=white) ![Folia](https://img.shields.io/badge/Folia-000000?style=flat-square&logoColor=white) ![Spigot](https://img.shields.io/badge/Spigot-ED8106?style=flat-square&logoColor=white) ![PlaceholderAPI](https://img.shields.io/badge/PlaceholderAPI-4B8BBE?style=flat-square&logoColor=white) ![Vault](https://img.shields.io/badge/Vault-7B42BC?style=flat-square&logo=vault&logoColor=white) ![Dynmap](https://img.shields.io/badge/Dynmap-4CAF50?style=flat-square&logoColor=white) ![Bluemap](https://img.shields.io/badge/Bluemap-2196F3?style=flat-square&logoColor=white)
